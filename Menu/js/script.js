...
headerTab.forEach((elem) => {
  elem.addEventListener('click', (e) => {
    ...
    let dataVelueH = elem.getAttribute('data-htab');
    let contentTabH = document.querySelector(dataVelueH);
    console.log(contentTabH.classList.value);



    contentTabH.classList.add('active');
